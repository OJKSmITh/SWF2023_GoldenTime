...
export const AmbSection = ({ Amb, PatientState }: IHosMain) => {
    ...
    useEffect(() => {
        ...
        const contract = new ethers.Contract("0xeA81499D293607501169B294da55A374E2aE1B81", goldenTime.abi, provider) // AMB 콘트랙트입니다.
            ...
            <Div key={index}>
                <DivContentWrapST width={"100%"} flex={"true"} justify={"space-between"}>
                    ...
                    <DivTextST
                        ...
                        align={"center"}
                    >
                        <Div3 color={v.tokenBool}>
                            {v.tokenBool === null ? (
                                <Text text="대기중" />
                            ) : v.tokenBool ? (
                                <Text text="후송중" color={true} />
                            ) : (
                                <Text text="타병원후송" color={true} />
                            )}
                        </Div3>
                    </DivTextST>
                </DivContentWrapST>
        ...
        <>
            <DivBasicST width={80} height={72}>
                {patientArray.length > 0 ? (
                    ...
                    <div style={{ margin: "15rem 0 0 0", width: "100%", fontSize: "3rem", textAlign: "center" }}>
                        대기 중입니다.
                    </div>
                )}
            </DivBasicST>
